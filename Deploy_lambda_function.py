...
bucket_name = 'user-activity-tracking-prod'  # Replace with your actual bucket name
role_arn = 'arn:aws:iam::211125559197:role/LambdaS3Role'  # Replace with your IAM role ARN
